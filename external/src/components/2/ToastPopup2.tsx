...
import { Toast2 } from 'external/src/components/2/Toast2.tsx';
...
import { newToastPopup } from 'external/src/components/ui3/ToastPopup.tsx';
...
const useStyles = createUseStyles({
  popup: {
    ...
    right: 0,
    left: 0,
    top: `calc(-1 * ${cssVar('space-m')})`, // Positions popup just above sidebar
...
/**
 * @deprecated Use ui3/ToastPopup instead
 */
export const ToastPopup2 = withNewCSSComponentMaybe(
  newToastPopup,
  function ToastPopup2({
    label,
    setLabel,
    updateCount,
    topNavElement,
