...
awslocal s3 mb s3://radical-stack-fileuploads-wumx9efffh4z --region eu-west-2
...
awslocal s3 mb s3://cord-public-uploads --region eu-west-2
...
awslocal s3 mb s3://custom-s3-bucket --region eu-west-2
