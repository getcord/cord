...
export type CustomerApplicationsQueryArgs = {
  customerID: UUID;
};

export type HeimdallSwitchAdminQueryArgs = {
  key: string;
};

export type CustomerConsoleUsersQueryArgs = {
  customerID: UUID;
};
...
export type CordSessionTokenQueryArgs = {
  privateOrgWithUser: Maybe<UUID>;
};

export type GoRedirectQueryArgs = {
  name: string;
};

export type CustomerIssueQueryArgs = {
  id: UUID;
};

export type CustomerIssuesQueryArgs = {
  customerID: Maybe<UUID>;
};

export type CustomerIssueCordSessionTokenQueryArgs = {
  issueID: UUID;
};
...
export type Query = {
  ...
  customer: Maybe<M['Customer']>;
  customerApplications: Array<Maybe<M['Application']>>;
  heimdallSwitches: Array<M['HeimdallSwitch']>;
  heimdallSwitchAdmin: Maybe<M['HeimdallSwitch']>;
  customerConsoleUsers: Array<M['ConsoleUser']>;
  featureFlags: Array<M['FeatureFlag']>;
  cordSessionToken: Maybe<M['String']>;
  adminPlatformUsers: Array<M['AdminChatUser']>;
  goRedirect: Maybe<M['AdminGoRedirect']>;
  testToken: M['TestToken'];
  customerIssue: M['CustomerIssue'];
...
export type CreateHeimdallSwitchMutationArgs = {
  key: string;
};

export type FlipHeimdallSwitchMutationArgs = {
  key: string;
  value: boolean;
};
...
export type ToggleInternalFlagOnOrgMutationArgs = {
  orgID: UUID;
};
...
export type UpdateCustomerMutationArgs = {
  id: UUID;
  name: Maybe<string>;
...
export type SetGoRedirectMutationArgs = {
  redirect: AdminGoRedirectInputType;
};
...
export type DeleteCustomerIssueMutationArgs = {
  id: UUID;
};

export type AddCustomerIssueSubscriptionMutationArgs = {
  issueID: UUID;
};

export type RemoveCustomerIssueSubscriptionMutationArgs = {
  issueID: UUID;
};

export type SendSlackMessageToCustomersMutationArgs = {
  type: CustomerSlackMessageType;
  message: string;
  customers: Array<string>;
};

export type CreateStripeCustomerMutationArgs = {
  id: UUID;
  email: string;
  country: string;
  postcode: string;
...
export type CreateStripeSubscriptionMutationArgs = {
  id: UUID;
  price: Float;
  recurrence: string;
...
export type Mutation = {
  ...
  createHeimdallSwitch: M['HeimdallSwitch'];
  flipHeimdallSwitch: M['SuccessResult'];
  createApplication: M['UUID'];
  updateApplication: M['SuccessResult'];
  toggleInternalFlagOnOrg: M['SuccessResult'];
  createCustomer: M['UUID'];
  updateCustomer: M['SuccessResult'];
  addConsoleUserToCustomer: M['SuccessResult'];
  removeConsoleUserFromCustomer: M['SuccessResult'];
  setGoRedirect: M['SuccessResult'];
  createCustomerIssue: M['SuccessResult'];
  updateCustomerIssue: M['SuccessResult'];
  deleteCustomerIssue: M['SuccessResult'];
  addCustomerIssueSubscription: M['SuccessResult'];
  removeCustomerIssueSubscription: M['SuccessResult'];
  sendSlackMessageToCustomers: M['SuccessResult'];
  createStripeCustomer: M['SuccessResult'];
  createStripeSubscription: M['SuccessResult'];
};
...
export type CustomerSlackChannelsResult = {
  id: M['UUID'];
  name: M['String'];
  slackChannelName: M['String'];
};
...
type QueryResolver = {
  ...
  customerApplications: (
    parent: M['Query'],
    args: CustomerApplicationsQueryArgs,
    context: RequestContext,
  ) => Array<Maybe<M['Application']>> | Promise<Array<Maybe<M['Application']>>>;
  heimdallSwitches: (
    parent: M['Query'],
    args: Record<string, never>,
    context: RequestContext,
  ) => Array<M['HeimdallSwitch']> | Promise<Array<M['HeimdallSwitch']>>;
  heimdallSwitchAdmin: (
    parent: M['Query'],
    args: HeimdallSwitchAdminQueryArgs,
    context: RequestContext,
  ) => Maybe<M['HeimdallSwitch']> | Promise<Maybe<M['HeimdallSwitch']>>;
  customerConsoleUsers: (
    parent: M['Query'],
    args: CustomerConsoleUsersQueryArgs,
    context: RequestContext,
  ...
  cordSessionToken: (
    parent: M['Query'],
    args: CordSessionTokenQueryArgs,
    context: RequestContext,
  ) => Maybe<M['String']> | Promise<Maybe<M['String']>>;
  adminPlatformUsers: (
    parent: M['Query'],
    args: Record<string, never>,
    context: RequestContext,
  ) => Array<M['AdminChatUser']> | Promise<Array<M['AdminChatUser']>>;
  goRedirect: (
    parent: M['Query'],
    args: GoRedirectQueryArgs,
    context: RequestContext,
  ) => Maybe<M['AdminGoRedirect']> | Promise<Maybe<M['AdminGoRedirect']>>;
  testToken: (
    parent: M['Query'],
    args: Record<string, never>,
    context: RequestContext,
  ) => M['TestToken'] | Promise<M['TestToken']>;
  customerIssue: (
    parent: M['Query'],
    args: CustomerIssueQueryArgs,
    context: RequestContext,
  ) => M['CustomerIssue'] | Promise<M['CustomerIssue']>;
  customerIssues: (
    parent: M['Query'],
    args: CustomerIssuesQueryArgs,
    context: RequestContext,
  ) => Array<M['CustomerIssue']> | Promise<Array<M['CustomerIssue']>>;
  customerIssueCordSessionToken: (
    parent: M['Query'],
    args: CustomerIssueCordSessionTokenQueryArgs,
    context: RequestContext,
  ) => Maybe<M['String']> | Promise<Maybe<M['String']>>;
  customerSlackChannels: (
    ...
    | Array<M['CustomerSlackChannelsResult']>
    | Promise<Array<M['CustomerSlackChannelsResult']>>;
};
...
type MutationResolver = {
  ...
  createHeimdallSwitch: (
    parent: M['Mutation'],
    args: CreateHeimdallSwitchMutationArgs,
    context: RequestContext,
  ) => M['HeimdallSwitch'] | Promise<M['HeimdallSwitch']>;
  flipHeimdallSwitch: (
    parent: M['Mutation'],
    args: FlipHeimdallSwitchMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  createApplication: (
    parent: M['Mutation'],
  ...
  toggleInternalFlagOnOrg: (
    parent: M['Mutation'],
    args: ToggleInternalFlagOnOrgMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  createCustomer: (
    parent: M['Mutation'],
  ...
  updateCustomer: (
    parent: M['Mutation'],
    args: UpdateCustomerMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  ...
  setGoRedirect: (
    parent: M['Mutation'],
    args: SetGoRedirectMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  createCustomerIssue: (
    parent: M['Mutation'],
  ...
  deleteCustomerIssue: (
    parent: M['Mutation'],
    args: DeleteCustomerIssueMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  addCustomerIssueSubscription: (
    parent: M['Mutation'],
    args: AddCustomerIssueSubscriptionMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  removeCustomerIssueSubscription: (
    parent: M['Mutation'],
    args: RemoveCustomerIssueSubscriptionMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  sendSlackMessageToCustomers: (
    parent: M['Mutation'],
    args: SendSlackMessageToCustomersMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  createStripeCustomer: (
    parent: M['Mutation'],
    args: CreateStripeCustomerMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
  createStripeSubscription: (
    parent: M['Mutation'],
    args: CreateStripeSubscriptionMutationArgs,
    context: RequestContext,
  ) => M['SuccessResult'] | Promise<M['SuccessResult']>;
};
...
type CustomerSlackChannelsResultResolver = {
  id: (
    parent: M['CustomerSlackChannelsResult'],
    args: Record<string, never>,
    context: RequestContext,
  ) => M['UUID'] | Promise<M['UUID']>;
  name: (
